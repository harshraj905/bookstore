                ...
                <div class="row">
                    <div class="col-lg-4">
                        <ul class="header-top-list">
                            <li class="dropdown-trigger currency-dropdown"><a href="">₹ INR </a>
                            ...
                            <li class="dropdown-trigger language-dropdown"><a href=""><span class="flag-img"><img
                                            src="image/icon/eng-flag.png" alt=""></span>English </a>
                                <!-- <ul class="dropdown-box">
                    ...
                    <div class="container">
                        <div class="home-content text-center">
                            <div class="row justify-content-end">
                                <div class="col-lg-6">
                                    <h1>Where Words Take Flight:</h1>
                                    <h2> Your Journey Begins with Falak Publication.
                                        </h2>
                ...
                <div class="single-slide bg-image  bg-overlay--dark" data-bg="image/bg-images/home-3-slider-2.jpg">
                    <div class="container">
                        <div class="home-content pl--30">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h1>Unlocking Worlds,</h1>
                                    <h2> One Page at a Time.
                                     </h2>
                                    <a href="shop-grid.php" class="btn btn--yellow">
                                        Shop Now
                                    </a>
        ...
        <section class="pt--30 section-margin">
            ...
            <div class="container">
                <div class="category-gallery-block">
                    <a href="#comic" class="single-block hr-large">
                        <img src="image/others/cat-gal-large.png" alt="">
                    </a>
                    <div class="single-block inner-block-wrapper">
                        <a href="#arts" class="single-image mid-image">
                            <img src="image/others/cat-gal-mid.png" alt="">
                        </a>
                        <a href="#business" class="single-image small-image">
                            <img src="image/others/cat-gal-small.png" alt="">
                        </a>
                        <a href="#childern" class="single-image small-image">
                            <img src="image/others/cat-gal-small-2.jpg" alt="">
                        </a>
                        <a href="#travel" class="single-image mid-image">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mt--30">
                        <div class="feature-box h-100">
                            ...
                            <div class="text">
                                <h5>Help & Support</h5>
                                <p>Mail us : falakpublishers@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">Rpple QPad with Retina Display
                                                        MD510LL/A</a></h3>
                                            </div>
                                            <div class="product-card--body">
                                                <div class="card-image">
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">Koss KPH7 Lightweight Portable
                                                        Headphone</a></h3>
                                            </div>
                                            <div class="product-card--body">
                                                <div class="card-image">
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">Beats EP Wired On-Ear
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">Beats Solo2 Solo 2 Wired On-Ear
                                                        Headphone</a></h3>
                                            </div>
                                            <div class="product-card--body">
                                                <div class="card-image">
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">Beats Solo3 Wireless On-Ear
                                                        Headphones                      
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">3 Ways To Have (A) More Appealing
                                                        BOOK</a></h3>
                                            </div>
                                            <div class="product-card--body">
                                                <div class="card-image">
                                    ...
                                    <div class="single-slide">
                                        <div class="product-card">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="product-details.php">In 10 Minutes, I'll Give You The
                                                        Truth About</a></h3>
                                            </div>
                                            <div class="product-card--body">
                                                <div class="card-image">
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="product-details.php">5 Ways To Get Through
                                                                    To Your BOOK</a></h3>
                                                        </div>
                                                        <div class="price-block">
                                                            <span class="price">₹51.20</span>
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="product-details.php">Find About
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="product-details.php">Koss KPH7 Light weight
                                                                    Portable</a></h3>
                                                        </div>
                                                        <div class="price-block">
                                                            <span class="price">₹51.20</span>
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="product-details.php">In 10 Minutes, I'll
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="product-details.php">Apple iPad with
                                                                    Retina Display</a></h3>
                                                        </div>
                                                        <div class="price-block">
                                                            <span class="price">₹51.20</span>
