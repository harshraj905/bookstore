			...
			<div class="container">
						...
						<form method="POST">
							<div class="login-form">
								...
								<p><span class="font-weight-bold">Login using your credentials</span></p>
								<div class="row">
									...
									<p style="margin-top: 20px;">Don't have an account? <a href="register.php" style="color:#85a28d;">Register now</a></p>
